...
public class Create3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card.setBackgroundResource(R.drawable.design4);
      //  templets=(Button)findViewById(R.id.temp);
        ...
        ActivityCompat.requestPermissions(Create3.this, new String[] {Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.WRITE_EXTERNAL_STORAGE}, PackageManager.PERMISSION_GRANTED);
       /* templets.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(Create3.this,temp.class);
                intent.putExtra("create","create3");
    ...
    public void Createpdf(View view) {
      ...
      /*  View v1 = view.getRootView();
        ...
        try {
            ...
            Toast.makeText(Create3.this,"Created in Internal Storage",Toast.LENGTH_LONG).show();

        }
        catch (Exception e){
            e.printStackTrace();
            Toast.makeText(Create3.this,"Error",Toast.LENGTH_LONG).show();
        }
        myDocument.close();
