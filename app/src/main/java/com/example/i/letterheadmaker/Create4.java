...
public class Create4 extends AppCompatActivity {
    CardView card;
   ...
   // Button templets;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card.setBackgroundResource(R.drawable.design5);
        ...
        ActivityCompat.requestPermissions(Create4.this, new String[] {Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.WRITE_EXTERNAL_STORAGE}, PackageManager.PERMISSION_GRANTED);
       /* templets.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent =new Intent(Create4.this,temp.class);
                intent.putExtra("create","create4");
    ...
    public void Createpdf(View view) {
      ...
      /*  View v1 = view.getRootView();
        ...
        try {
            ...
            Toast.makeText(Create4.this,"Created in Internal Storage",Toast.LENGTH_LONG).show();

        }
        catch (Exception e){
            e.printStackTrace();
            Toast.makeText(Create4.this,"Error",Toast.LENGTH_LONG).show();
        }
        myDocument.close();
